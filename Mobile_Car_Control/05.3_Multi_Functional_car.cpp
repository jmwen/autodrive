...
void handleControl(unsigned long value) 
{
  ...
  switch (value) {
    ...
    case 0xD7E84B1B:
      Motor_Move(pos_speed_value,pos_speed_value,pos_speed_value,pos_speed_value);
      break;
    case 0xFF9867:// Receive the number '-'
    case 0x97483BFB:
      Motor_Move(neg_speed_value,neg_speed_value,neg_speed_value,neg_speed_value);
      break;
    ...
    case 0xF0C41643:
      servo_2_angle=servo_2_angle+servo_adjust_angle;
      Servo_2_Angle(servo_2_angle);
      break;      
